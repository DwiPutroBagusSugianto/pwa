...
const DB = {
  users: [
    ...
    { id: 2, name: 'Sevti Ariyani', email: 'sevti@infotama.net.id', password: 'sevti123', role: 'employee', department: 'HR', avatar: 'SA' },
    { id: 3, name: 'Dhika', email: 'dhika@infotama.net.id', password: 'karyawan123', role: 'employee', department: 'NOC', avatar: 'DH' },
  ],
